...
function getDate(str: string): DateTime {
...
const DATE_MONDAY = getDate('2025-10-20');
const DATE_FRIDAY = getDate('2025-10-24');
const DATE_SATURDAY = getDate('2025-10-25');
const DATE_SUNDAY = getDate('2025-10-26');
